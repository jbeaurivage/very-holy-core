...
set sourceDirs [list "./target/veryl" "./target/veryl/fpga" "./target/veryl/memory" "target/veryl/peripherals" "target/veryl/cpu" "./target/veryl/cpu/load_store" "target/veryl/cpu/writeback"]
